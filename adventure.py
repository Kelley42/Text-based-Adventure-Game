...
def intro():
    ...
    print(wrapper.fill(text = "--->\tA storm has shipwrecked you and your crew on a tropical island. There are rumors that the island had a terrible curse put upon it long ago. Numerous treasure ships have mysteriously sunk along its coast, and the few who survived insisted that anyone who stepped foot on land was never seen again.\n\tNight has fallen and you have woken up on the beach alone in the cold rain. You can't see or hear any of your crew members. Cold and wet, you can't stop shivering. Suddenly you hear rustling in the bushes behind you.\n"))
...
def hungry():
    ...
    hungry_response = input("Do you explore the island for food, climb a coconut tree, or stay put? ").lower()
...
def waterfall():
    ...
    waterfall_response = input("Do you drink from the lake, bathe in it, or go behind the waterfall? ").lower()
...
def behind_waterfall():
    ...
    behind_waterfall_response = input('Do you look at the drawings, call out, or run away? ').lower()
...
def drawing():
    ...
    drawing_response = input("Do you go further into the cave or run away? ").lower()
...
def center_island2():
    ...
    center_island2_response = input("Do you take the path that goes down or up? ").lower()
